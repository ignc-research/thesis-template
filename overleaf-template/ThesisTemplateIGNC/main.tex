...
\include{content/1_introduction/index}
\include{content/2_relatedworks/index}
\include{content/3_fundamentals/index}
\include{content/4_conceptualdesign/index}
\include{content/5_implementation/index}
\include{content/6_evaluation/index}
\include{content/7_conclusion/conclusion}
\include{content/8_futurework/futurework}
